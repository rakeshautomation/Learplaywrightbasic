...
test("Basic verify how to handle multiple direct elements", async ({ page }) => {
    ...
    console.log("Assertion passed: URL successfully updated to include #forgotten-password!");
});